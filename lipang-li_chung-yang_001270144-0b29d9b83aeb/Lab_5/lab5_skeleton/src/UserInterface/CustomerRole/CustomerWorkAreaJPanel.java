...
public class CustomerWorkAreaJPanel extends javax.swing.JPanel {
    ...
    public CustomerWorkAreaJPanel(JPanel upc, SupplierDirectory sd, MasterOrderCatalog moc) {
        initComponents();
        this.upc = upc;
        this.sd = sd;
        this.moc = moc;
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        BrowseProducts bp = new BrowseProducts(upc, sd, moc);
        upc.add("BrowseProducts", bp);
