...
public class ManageCustomerJPanel extends javax.swing.JPanel {
    ...
    public ManageCustomerJPanel(JPanel CardSequenceJPanel, AirlinerDirectory ad) {
        initComponents();        
    ...
    public void populateTable(){
        ...
        for(Customer c : cd.getCustomerDirectory()){
    ...
    private void btnViewCustomerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnViewCustomerActionPerformed
        ...
        if(selectedrow >=0){
            ...
            BookAllFlighsJPanel panel = new BookAllFlighsJPanel(CardSequenceJPanel, ad, c, this); 
